...
export class OrdersComponent implements OnInit {
  ...
  constructor(
    ...
    this.createModel.orderDate = this.datePipe.transform(new Date(), "yyyy-MM-dd") ?? "";
    this.createModel.deliveryDate = this.datePipe.transform(new Date(), "yyyy-MM-dd") ?? "";
  }
  ...
  deleteById(model: OrderModel) {
    ...
    this.swal.callSwal("Siparişi Sil?", `${model.orderPrefix} ait ${number} sipraişini silmek istiyor musunuz`, () => {
